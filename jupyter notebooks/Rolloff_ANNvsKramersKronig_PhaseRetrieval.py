...
# local oscillator (LO)
FO = 4e9 + paramTx.Rs/2  # frequency offset
...
plt.plot(Rolloff, np.log10(SER_KK), '-o', label='KK Algorithm')
plt.xlabel('Rolloff factor RRC')
plt.ylabel('$SER$')
plt.grid()
plt.legend()
...
plt.tight_layout()
#plt.savefig(r'C:\Users\Silas João\Documents\GitHub\PIVIC-Comunicacoes-Opticas\resultados\results_RolloffRRC_64QAM.png', dpi=600)
